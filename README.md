# Terra-Mira-Public
Public repository of release builds for Terra Mira
...
There is also an attached document that has more information on the highlights, planned systems, and overall structure.
...
as well as everything you'd expect like HP/AP/mana/stamina
inventory
items
etc...
...
I initially started with C#, completed the Monogame tutorial, then came to this section (https://docs.monogame.net/articles/tutorials/building_2d_games/25_packaging_game/index.html?tabs=windows#code-obfuscation)
